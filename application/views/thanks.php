    ...
    <!-- Navbar -->
      ...
      <div id='content'>
        <div class='panel panel-default'>
          ...
          <a class="btn btn-primary" href="<?php echo base_url('index.php/cart/checkout') ?>" >Lengkapi Pembayaran</a>
          </div>
         
          <div class='panel-body'>

            
           <center>----------------------- Terimakasih telah membeli buku di toko kami !! ----------------------------<br></center>
